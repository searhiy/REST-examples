...
public @interface MatchingPackageNumbers {
    ...
    public static class MatchingPackageNumbersValidator implements ConstraintValidator<MatchingPackageNumbers, TicketEx> {
        ...
        @Override
        public boolean isValid(TicketEx ticket, ConstraintValidatorContext constraintValidatorContext) {
